  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center space-x-2">
        ...
        <span className="text-white font-medium text-xl">AI Notes</span>
      </Link>

      <div className="flex items-center space-x-4">
        <Link href={"https://github.com/Pratiyankkumar"}>
          <div className=" h-9 flex items-center justify-center cursor-pointer  mr-4 w-9 rounded-md transition-all duration-200 hover:bg-gray-800/50">
            <svg
